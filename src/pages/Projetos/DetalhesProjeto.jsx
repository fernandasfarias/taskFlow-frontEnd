...
import {
    HiArrowLeft, HiOutlineCalendar, HiOutlineUsers,
    HiOutlineCurrencyDollar, HiOutlineOfficeBuilding,
    HiOutlineBriefcase, HiOutlineClipboardList,
} from 'react-icons/hi';
import Sidebar from '../../features/dashboard/components/Sidebar';
import { buscarProjeto, listarColaboradoresDoProjeto, listarClientesDoProjeto } from '../../services/projetoService';
...
function PessoaRow({ nome, subtitulo, isCliente }) {
    return (
            ...
            <div className="flex-1 overflow-y-auto h-screen">
                <div className="p-8 lg:p-10 max-w-6xl mx-auto flex flex-col gap-8">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        ...
                        <button
                            onClick={() => navigate(`/projetos/associar-colaboradores`, { state: { projeto } })}
