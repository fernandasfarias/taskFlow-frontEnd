    ...
    <div>
      <div className="relative">
        <input
          ...
          className={`w-full placeholder-[#98928A] bg-transparent text-base md:text-lg py-4 md:py-4 px-6 ${
            ehSenha ? "pr-14" : ""
          } rounded-2xl md:rounded-3xl border-[2px] border-solid border-[#30363D] focus:border-[#7C3AED] focus:outline-none transition-colors font-normal text-white`}
        />
