...
export default function Autenticacao() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0E17] flex items-end md:items-center justify-center md:p-6 font-sans overflow-hidden relative">
      ...
      {/* TELA 1: INTRO MOBILE */}
      <div
        className={`absolute inset-0 flex flex-col justify-between p-8 pt-20 pb-12 z-0 md:hidden transition-opacity duration-300 ${introMobile ? "opacity-100" : "opacity-0 pointer-events-none"}`}
      >
      ...
      <div
        className={`w-full max-w-[1280px] bg-[#161B22] border border-gray-800 relative overflow-hidden flex text-white z-20 
      ...
      >
        ...
        <div className="flex-1 flex w-full h-full">
          <div
            className={`flex-1 flex-col justify-start md:justify-center px-6 md:px-10 lg:px-20 py-10 md:py-8 h-full overflow-y-auto custom-scrollbar ${!ehCadastro ? "hidden md:flex" : "flex"}`}
          >
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-end w-full">
          <Link
            to="/recuperar-senha"
            className="text-sm text-[#98928A] hover:text-[#A78BFA] transition-colors mt-1"
          >
            Esqueci minha senha
          </Link>
        </div>
        ...
        <div className="w-full text-center mt-4">
          <span className="text-sm md:text-base font-normal text-[#98928A]">
            ...
            <button
              ...
              className="text-white hover:underline font-bold hover:text-[#A78BFA] transition-colors mt-1"
            >
              Cadastre-se.
            </button>
          </span>
  ...
  return (
    <>
      <img
        ...
        alt="Logo"
      />
      <h2 className="text-4xl lg:text-5xl font-bold mb-6 md:mb-10 text-white">
        Cadastre-se
      </h2>
            ...
            <Input
              ...
              regras={{
                ...
                validate: (valor: string) =>
                  valor === senhaDigitada || "As senhas não batem!",
              }}
            />
          </div>
        </div>
        ...
        <div>
          <div className="relative">
            ...
            >
              ...
              <option value="CLIENTE" className="bg-[#161B22] text-white">
                Cliente
              </option>
              <option value="COLABORADOR" className="bg-[#161B22] text-white">
                Colaborador
              </option>
              <option
          ...
          {errors.tipoConta && (
            <span className="text-red-500 text-xs mt-1 ml-4 block font-normal">
              {String(errors.tipoConta.message)}
            </span>
          )}
        </div>
